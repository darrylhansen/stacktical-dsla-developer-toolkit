...
interface RedstoneConsumerNumericBaseInterface extends ethers.utils.Interface {
  functions: {
...
export class RedstoneConsumerNumericBase extends BaseContract {
