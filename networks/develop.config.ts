...
export const develop: NetworkUserConfig = {
  ...
  stacktical: {
    ...
    messengers: [
      ...
      {
        contract: CONTRACT_NAMES.TravelRedstoneOracle,
        useCaseName: USE_CASES.TRAVEL_REDSTONE,
        externalAdapterUrl: process.env.TRAVEL_REDSTONE_ADAPTER,
        dslaLpName: SERVICE_CREDITS.TRAVEL_REDSTONE.DSLA_LP.name,
        dslaLpSymbol: SERVICE_CREDITS.TRAVEL_REDSTONE.DSLA_LP.symbol,
        dslaSpName: SERVICE_CREDITS.TRAVEL_REDSTONE.DSLA_SP.name,
        dslaSpSymbol: SERVICE_CREDITS.TRAVEL_REDSTONE.DSLA_SP.symbol,
      },
    ],
    scripts: scripts,
  },
