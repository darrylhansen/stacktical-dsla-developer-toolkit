...
export const scripts: ScriptsConfiguration = {
  deploy_sla: [
    ...
    // INDEX 26, OpenAI Status Page SLA: Respected case
    {
      sloValue: 95,
      sloType: SLO_TYPE.GreaterThan,
      whitelisted: false,
      periodType: PERIOD_TYPE.MONTHLY,
      messengerContract: CONTRACT_NAMES.StatusPageOracle,
      initialPeriodId: 4,
      finalPeriodId: 6,
      severity: [],
      penalty: [],
      ...
      leverage: 1,
      serviceMetadata: {
        serviceName: 'OpenAI Status Page SLA - Respected case',
        serviceDescription: 'SLA for OpenAI Public Status Page',
        serviceImage: 'https://via.placeholder.com/1200x600',
        serviceURL: 'https://status.openai.com/',
        serviceAddress: '0x0000000000000000000000000000000000000000',
        serviceTicker: 'STATUSPAGE',
        statusPageUrl: 'https://status.openai.com/api/v2',
        component: ['chat.openai.com', 'API'],
        impactCutoff: 'minor',
        serviceUseTestExternalAdapter: true,
        serviceSliMockingPlan: [99, 99, 99, 99, 99],
      },
    },
    // INDEX 27, OpenAI Status Page SLA: Not Respected case
    {
      sloValue: 99.9,
      sloType: SLO_TYPE.GreaterThan,
      whitelisted: false,
      ...
      leverage: 1,
      serviceMetadata: {
        serviceName: 'OpenAI Status Page SLA - Not Respected case',
        serviceDescription: 'SLA for OpenAI Public Status Page',
        serviceImage: 'https://via.placeholder.com/1200x600',
        serviceURL: 'https://status.openai.com/',
        serviceAddress: '0x0000000000000000000000000000000000000000',
        serviceTicker: 'STATUSPAGE',
        statusPageUrl: 'https://status.openai.com/api/v2',
        component: ['chat.openai.com', 'API', 'labs.openai.com', 'Playground Site'],
        impactCutoff: 'minor',
        serviceUseTestExternalAdapter: true,
        serviceSliMockingPlan: [95, 95, 95, 95, 95],
      },
    },
    // INDEX 28, Zoom Status Page SLA: Not Respected case
    {
      sloValue: 99.9,
      sloType: SLO_TYPE.GreaterThan,
      whitelisted: false,
      ...
      leverage: 1,
      serviceMetadata: {
        serviceName: 'Zoom Status Page SLA - Not Respected case',
        serviceDescription: 'SLA for Zoom Public Status Page',
        serviceImage: 'https://via.placeholder.com/1200x600',
        serviceURL: 'https://status.zoom.us/',
        serviceAddress: '0x0000000000000000000000000000000000000000',
        serviceTicker: 'STATUSPAGE',
        statusPageUrl: 'https://status.zoom.us/api/v2',
        component: ['Zoom Events', 'SMS/MMS (Inbound/Outbound)', 'Zoom Phone', 'Zoom Meetings', 'Zoom Dashboard & Reporting'],
        impactCutoff: 'minor',
        serviceUseTestExternalAdapter: true,
        serviceSliMockingPlan: [95, 95, 95, 95, 95],
      },
    },
    // INDEX 29, Zoom Status Page SLA: Respected case
    {
      sloValue: 99,
      sloType: SLO_TYPE.GreaterThan,
      whitelisted: false,
      ...
      leverage: 1,
      serviceMetadata: {
        serviceName: 'Zoom Status Page SLA - Respected case',
        serviceDescription: 'SLA for Zoom Public Status Page',
        serviceImage: 'https://via.placeholder.com/1200x600',
        serviceURL: 'https://status.zoom.us/',
        serviceAddress: '0x0000000000000000000000000000000000000000',
    ...
    // INDEX 30, Github Status Page SLA: Respected case
    {
      sloValue: 50,
      sloType: SLO_TYPE.GreaterThan,
      whitelisted: false,
      ...
      leverage: 1,
      serviceMetadata: {
        serviceName: 'Github Status Page SLA - Respected case',
        serviceDescription: 'SLA for Github Public Status Page',
        serviceImage: 'https://via.placeholder.com/1200x600',
        serviceURL: 'https://www.githubstatus.com/',
        serviceAddress: '0x0000000000000000000000000000000000000000',
        serviceTicker: 'STATUSPAGE',
        statusPageUrl: 'https://www.githubstatus.com/api/v2/',
        component: ['Copilot', 'Codespaces', 'Git Operations', 'Pull Requests', 'Actions', 'Packages', 'Webhooks'],
        impactCutoff: 'minor',
        serviceUseTestExternalAdapter: true,
        serviceSliMockingPlan: [95, 95, 95],
      },
    },
    // INDEX 31, Github Status Page SLA: Respected case
    {
      sloValue: 98,
      sloType: SLO_TYPE.GreaterThan,
      whitelisted: false,
